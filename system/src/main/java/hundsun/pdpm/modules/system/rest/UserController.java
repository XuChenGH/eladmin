...
import hundsun.pdpm.domain.VerificationCode;
import hundsun.pdpm.exception.BadRequestException;
import hundsun.pdpm.modules.system.domain.User;
import hundsun.pdpm.modules.system.domain.vo.UserPassVo;
import hundsun.pdpm.modules.system.service.DeptService;
...
import hundsun.pdpm.service.VerificationCodeService;
import hundsun.pdpm.utils.ElAdminConstant;
...
import hundsun.pdpm.config.DataScope;
...
public class UserController {
    ...
    @PreAuthorize("@el.check('custUser:list','custUser:add')")
    public ResponseEntity getAll(UserQueryCriteria criteria){
