...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <div style="list-style: none;
			...
			font-size: 14px;
            color: #555;">
            <p style="line-height: 12px;">网站地址：<a hover="color: #DA251D;" style="color: #999;" href="https://github.com/elunez/eladmin" target="_blank">http://10.20.30.43:8081/</a></p>
        </div>
        ...
        <div style="text-align: center;
			...
			font-family: Microsoft YaHei;">
                Copyright &copy;${.now?string("yyyy")} PDPM 研发过程管理系统 All Rights Reserved.
        </div>
