...
import hundsun.pdpm.domain.vo.TableInfo;
import hundsun.pdpm.utils.GenUtil;
...
public class GeneratorServiceImpl implements GeneratorService {
    ...
    public Object getColumns(String name) {
        ...
        for (Object obj : result) {
            Object[] arr = (Object[]) obj;
            columnInfos.add(new ColumnInfo(arr[0],arr[1],arr[2],arr[3],arr[4],arr[5],null,null,"true"));
        }
