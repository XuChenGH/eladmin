...
-- ----------------------------
INSERT INTO `gen_config` VALUES (1, 'Zheng Jie', b'0', 'eladmin-system', 'hundsun.pdpm.serviceice', 'E:\\workspace\\me\\front\\eladmin-qt\\src\\views\\test1111', 'E:\\workspace\\me\\front\\eladmin-qt\\src\\api', NULL);
...
CREATE TABLE `menu`  (
  ...
  `component_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建日期',
...
INSERT INTO `quartz_job` VALUES (2, 'testTask', '0/5 * * * * ?', b'1', '测试1', 'run1', 'service', '带参测试，多参使用json', '2019-08-22 14:08:29');
...
INSERT INTO `user` VALUES (3, NULL, 'service@eladmin.net', 1, 'e10adc3949ba59abbe56e057f20f883e', 'service', 2, '17777777777', 12, '2018-12-27 20:05:26', '2019-04-01 09:15:24');
